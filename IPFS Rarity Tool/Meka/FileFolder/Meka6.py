...
def scraped_JSON_list_gen():
    for i in range(5555, itemsInCollection - 2222):
...
def list_to_txt_file():
    ...
    traits = open(r"C:\Users\zache\OneDrive\Desktop\VS Code Files\Python\IPFS Rarity Tool\Meka\txtdump\traits6.txt","w+")
